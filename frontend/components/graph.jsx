...
class Graph extends React.Component {
  ...
  /**
   * Existing - 1day, 1week, 1month, 3month, 1year, 5year
   * API response - 1month, 1week, 1year, 3Month, 5year
   * Wanted to remove - 
   *      1min(DNE), 
   *      5min(DNE), 
   *      1hour(DNE), 
   ...
   *      1year, 
   *      5year
   * Existing to remove - 1year and 5year
   * will be remained after - 1day, 1week, 1month, 3month,
   */
